...
You are running inside a fresh git worktree under a `claude-fleet` daemon. The body of this file is your prompt.
...
- The summary should be the one-line string `Hello, claude-fleet`.
