...
:func:`claude_fleet.orchestrator.verdict_parser.parse_audit_report`, which is
...
from claude_fleet.orchestrator.verdict_parser import _LINE_RE
...
class MarkerFileAdapter(VerdictAdapter):
    ...
    def detect(self, worktree: Path, job_id: str) -> VerdictResult | None:
        ...
        from claude_fleet.orchestrator.backend import AuditVerdict  # noqa: PLC0415
