"""Preflight checks for ``rookery doctor``.
        ...
        return (
            CheckResult(
                ...
                remediation=(
                    ...
                    "Run 'rookery init' to create one."
                ),
            ),
            None,
        )
        ...
        try:
            ...
            return CheckResult(
                ...
                remediation=(
                    ...
                    "Run 'rookery init' to apply migrations."
                ),
            )
        conn.close()
    except Exception as exc:  # noqa: BLE001
        ...
        if pending:
            ...
            return CheckResult(
                ...
                remediation=(
                    ...
                    "Run 'rookery init --force' to apply."
                ),
            )
...
def _check_no_anthropic_api_key() -> CheckResult:
    ...
    if os.environ.get("ANTHROPIC_API_KEY"):
        return CheckResult(
            ...
            remediation=(
                "ANTHROPIC_API_KEY must NOT be set when using rookery. "
...
def run_checks(config_path: Path = Path("./rookery.yaml")) -> list[CheckResult]:
    ...
    Args:
        config_path: Path to ``rookery.yaml``.  Used for checks that
