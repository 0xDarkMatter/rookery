...
1. Explicit env var: ``$ROOKERY_WORKTREE_ID`` (caller-set override; also
...
Consumers read the canonical id via the env var:
    ...
    import os
    worktree_id = os.environ.get("ROOKERY_WORKTREE_ID") or resolve_worktree_id()
